/* gusb.vapi generated by vapigen, definitely do modify. */

/*
 * Manually edited to work around https://github.com/hughsie/libgusb/issues/109
 * Original comes from GUsb release 0.4.6
 */
